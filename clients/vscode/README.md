...
> **日本語のかみ砕いた説明**: これは、文章を書くための道具「VS Code」(エディタ)の中から llove を使えるようにする「追加パーツ」の説明書です。たとえるなら、いつも使っているノートに、便利なしおりや付せんを後から貼り足すようなものです。llove の本体(自分のパソコンの中で動いています)に話しかけて、「今どのバージョンが入っているか」「使っている部品にあやしいものが混じっていないか」「外に勝手につながっていないか」といったことを、見るだけ・確かめるだけのやり方で教えてくれます。書きかえはしないので安心です。この追加パーツは、ふつうの配布所(お店のような場所)を通さなくても、配布用のファイルを直接受け取って取り付けられるように作ってあります。
>
