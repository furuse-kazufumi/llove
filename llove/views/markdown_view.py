...
class MarkdownView(Static, View):
    ...
    def __init__(
        ...
        *,
        ...
        diagram_render: bool = False,
        diagram_renderers: dict[str, DiagramRendererFn] | None = None,
        diagram_image_callback: DiagramImageCallback | None = None,
    ...
    def hook(verb: str, args: list[str]) -> tuple[str, ...] | None:
        ...
        if verb == "by-tag":
            if not args:
                return None
            kind = args[0]
            valid = {"heading", "code", "table", "mermaid", "svg", "plantuml", "dot"}
